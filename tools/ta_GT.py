...
def main():
    ...
    if args.gen_adv_aug:
        if cfg.data.train.get("dataset") is not None:
            training_set_cfg = cfg.data.train.dataset
        else:
            training_set_cfg = cfg.data.train

        cfg.data.test.ann_file = training_set_cfg.ann_file
        cfg.data.val.ann_file = training_set_cfg.ann_file
        cfg.data.test.img_prefix = training_set_cfg.img_prefix
        cfg.data.val.img_prefix = training_set_cfg.img_prefix
    ...
    for p_cfg in  training_set_cfg.pipeline:
